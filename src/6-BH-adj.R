...
saveRDS(full_res %>% filter(H==1, subH=="b") %>% select(-c(H,subH)), here("results/unadjusted/H1a_who_res.RDS"))
...
saveRDS(full_adj_res %>% filter(H==1, subH=="b") %>% select(-c(H,subH)), here("results/adjusted/H1a_who_adj_res.RDS"))
...
saveRDS(full_adj_res %>% filter(H==1, subH=="b") %>% select(-c(H,subH)), here("results/adjusted/H1a_who_adj_emm_res.RDS"))
